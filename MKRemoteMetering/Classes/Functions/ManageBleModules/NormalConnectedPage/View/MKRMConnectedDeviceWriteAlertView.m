//
//  MKRMConnectedDeviceWriteAlertView.m
...
@interface MKRMConnectedDeviceWriteAlertView ()
...
@implementation MKRMConnectedDeviceWriteAlertView

- (void)dealloc {
    NSLog(@"MKRMConnectedDeviceWriteAlertView销毁");
}
