//
//  MKRMManageBleDeviceSearchView.m
...
@interface MKRMManageBleDeviceSearchView ()<UIGestureRecognizerDelegate>
...
@implementation MKRMManageBleDeviceSearchView

- (void)dealloc{
    NSLog(@"MKRMManageBleDeviceSearchView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKRMManageBleDeviceSearchView *view = [[MKRMManageBleDeviceSearchView alloc] init];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"MKRemoteMetering", @"MKRMManageBleDeviceSearchView", @"rm_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"MKRemoteMetering", @"MKRMManageBleDeviceSearchView", @"rm_wifiGraySignalIcon.png");
    }
