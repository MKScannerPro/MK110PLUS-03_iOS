//
//  MKRMManageBleDevicesSearchButton.m
...
@implementation MKRMManageBleDevicesSearchButtonModel
@end

@interface MKRMManageBleDevicesSearchButton ()
...
@implementation MKRMManageBleDevicesSearchButton
...
- (void)clearButtonPressed{
    ...
    if ([self.delegate respondsToSelector:@selector(rm_scanSearchButtonClearMethod)]) {
        [self.delegate rm_scanSearchButtonClearMethod];
    }
}

- (void)searchButtonPressed{
    if ([self.delegate respondsToSelector:@selector(rm_scanSearchButtonMethod)]) {
        [self.delegate rm_scanSearchButtonMethod];
    }
}

#pragma mark - setting
- (void)setDataModel:(MKRMManageBleDevicesSearchButtonModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKRMManageBleDevicesSearchButtonModel.class]) {
        return;
    }
...
- (UIImageView *)searchIcon{
    if (!_searchIcon) {
        ...
        _searchIcon.image = LOADICON(@"MKRemoteMetering", @"MKRMManageBleDevicesSearchButton", @"rm_searchGrayIcon.png");
    }
    return _searchIcon;
}
...
- (UIButton *)clearButton{
    if (!_clearButton) {
        ...
        [_clearButton setImage:LOADICON(@"MKRemoteMetering", @"MKRMManageBleDevicesSearchButton", @"rm_clearButtonIcon.png") forState:UIControlStateNormal];
