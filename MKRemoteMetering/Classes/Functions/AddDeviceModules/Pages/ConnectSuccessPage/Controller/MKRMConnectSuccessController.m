//
//  MKRMConnectSuccessController.m
...
@interface MKRMConnectSuccessController ()
...
@implementation MKRMConnectSuccessController

- (void)dealloc {
    NSLog(@"MKRMConnectSuccessController销毁");
}
...
- (void)saveButtonPressed {
    ...
    [MKRMDeviceDatabaseManager insertDeviceList:@[self.deviceModel] sucBlock:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_rm_addNewDeviceSuccessNotification"
                                                            object:nil
