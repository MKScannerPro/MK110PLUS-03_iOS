//
//  MKRMBleScannerFilterController.m
...
@interface MKRMBleScannerFilterController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKRMBleScannerFilterModel *dataModel;

@end

@implementation MKRMBleScannerFilterController

- (void)dealloc {
    NSLog(@"MKRMBleScannerFilterController销毁");
}
...
- (void)mk_rm_filterNormalTextFieldValueChanged:(NSString *)text index:(NSInteger)index {
    ...
    if (index == 1) {
        ...
        MKRMFilterNormalTextFieldCellModel *cellModel = self.section1List[1];
        cellModel.textFieldValue = text;
        return;
    }
}
...
- (void)loadSection1Datas {
    MKRMFilterNormalTextFieldCellModel *cellModel1 = [[MKRMFilterNormalTextFieldCellModel alloc] init];
    cellModel1.index = 0;
    ...
    MKRMFilterNormalTextFieldCellModel *cellModel2 = [[MKRMFilterNormalTextFieldCellModel alloc] init];
    cellModel2.index = 1;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteMetering", @"MKRMBleScannerFilterController", @"rm_saveIcon.png") forState:UIControlStateNormal];
...
- (MKRMBleScannerFilterModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRMBleScannerFilterModel alloc] init];
    }
    return _dataModel;
}
