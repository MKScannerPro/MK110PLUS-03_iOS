...
@interface MKRMBleDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKRMBleDeviceInfoModel *dataModel;

@end

@implementation MKRMBleDeviceInfoController

- (void)dealloc {
    NSLog(@"MKRMBleDeviceInfoController销毁");
...
- (MKRMBleDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRMBleDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
