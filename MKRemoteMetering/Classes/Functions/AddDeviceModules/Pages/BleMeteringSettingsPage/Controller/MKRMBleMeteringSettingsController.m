//
//  MKRMBleMeteringSettingsController.m
...
@interface MKRMBleMeteringSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKRMBleMeteringSettingsModel *dataModel;

@end

@implementation MKRMBleMeteringSettingsController

- (void)dealloc {
    NSLog(@"MKRMBleMeteringSettingsController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteMetering", @"MKRMBleMeteringSettingsController", @"rm_saveIcon.png") forState:UIControlStateNormal];
...
- (MKRMBleMeteringSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRMBleMeteringSettingsModel alloc] init];
    }
    return _dataModel;
}
