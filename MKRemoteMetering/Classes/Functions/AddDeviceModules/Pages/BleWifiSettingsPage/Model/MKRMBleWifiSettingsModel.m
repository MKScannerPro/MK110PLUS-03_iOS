...
@interface MKRMBleWifiSettingsModel ()
...
@implementation MKRMBleWifiSettingsModel
...
- (BOOL)readSecurityType {
    ...
    [MKRMInterface rm_readWIFISecurityWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSecurityType {
    __block BOOL success = NO;
    [MKRMInterface rm_configWIFISecurity:self.security sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiSSID {
    __block BOOL success = NO;
    [MKRMInterface rm_readWIFISSIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiSSID {
    __block BOOL success = NO;
    [MKRMInterface rm_configWIFISSID:self.ssid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiPassword {
    __block BOOL success = NO;
    [MKRMInterface rm_readWIFIPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiPassword {
    __block BOOL success = NO;
    [MKRMInterface rm_configWIFIPassword:self.wifiPassword sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPType {
    __block BOOL success = NO;
    [MKRMInterface rm_readWIFIEAPTypeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPType {
    __block BOOL success = NO;
    [MKRMInterface rm_configWIFIEAPType:self.eapType sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPUsername {
    __block BOOL success = NO;
    [MKRMInterface rm_readWIFIEAPUsernameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPUsername {
    __block BOOL success = NO;
    [MKRMInterface rm_configWIFIEAPUsername:self.eapUserName sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPPassword {
    __block BOOL success = NO;
    [MKRMInterface rm_readWIFIEAPPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPPassword {
    __block BOOL success = NO;
    [MKRMInterface rm_configWIFIEAPPassword:self.eapPassword sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPDomainID {
    __block BOOL success = NO;
    [MKRMInterface rm_readWIFIEAPDomainIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPDomainID {
    __block BOOL success = NO;
    [MKRMInterface rm_configWIFIEAPDomainID:self.domainID sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readVerifyServer {
    __block BOOL success = NO;
    [MKRMInterface rm_readWIFIVerifyServerStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configVerifyServer {
    __block BOOL success = NO;
    [MKRMInterface rm_configWIFIVerifyServerStatus:self.verifyServer sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configCAFile {
    ...
    [MKRMInterface rm_configWIFICAFile:caData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientKey {
    ...
    [MKRMInterface rm_configWIFIClientPrivateKey:clientKeyData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientCert {
    ...
    [MKRMInterface rm_configWIFIClientCert:clientCertData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readCountryBand {
    __block BOOL success = NO;
    [MKRMInterface rm_readCountryBandWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
