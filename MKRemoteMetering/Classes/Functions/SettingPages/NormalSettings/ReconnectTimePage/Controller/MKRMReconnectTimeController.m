...
@interface MKRMReconnectTimeController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKRMReconnectTimeModel *dataModel;

@end

@implementation MKRMReconnectTimeController

- (void)dealloc {
    NSLog(@"MKRMReconnectTimeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteMetering", @"MKRMReconnectTimeController", @"rm_saveIcon.png") forState:UIControlStateNormal];
...
- (MKRMReconnectTimeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRMReconnectTimeModel alloc] init];
    }
    return _dataModel;
}
