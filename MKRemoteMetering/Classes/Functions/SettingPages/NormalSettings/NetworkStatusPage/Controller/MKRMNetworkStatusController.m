...
@interface MKRMNetworkStatusController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKRMNetworkStatusModel *dataModel;

@end

@implementation MKRMNetworkStatusController

- (void)dealloc {
    NSLog(@"MKRMNetworkStatusController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteMetering", @"MKRMNetworkStatusController", @"rm_saveIcon.png") forState:UIControlStateNormal];
...
- (MKRMNetworkStatusModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRMNetworkStatusModel alloc] init];
    }
    return _dataModel;
}
