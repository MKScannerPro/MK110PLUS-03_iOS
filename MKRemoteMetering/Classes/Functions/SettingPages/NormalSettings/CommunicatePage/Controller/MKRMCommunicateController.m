...
@interface MKRMCommunicateController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKRMCommunicateModel *dataModel;

@end

@implementation MKRMCommunicateController

- (void)dealloc {
    NSLog(@"MKRMCommunicateController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteMetering", @"MKRMCommunicateController", @"rm_saveIcon.png") forState:UIControlStateNormal];
...
- (MKRMCommunicateModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRMCommunicateModel alloc] init];
    }
    return _dataModel;
}
