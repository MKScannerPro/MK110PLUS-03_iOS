...
@interface MKRMDataReportController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKRMDataReportModel *dataModel;

@end

@implementation MKRMDataReportController

- (void)dealloc {
    NSLog(@"MKRMDataReportController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteMetering", @"MKRMDataReportController", @"rm_saveIcon.png") forState:UIControlStateNormal];
...
- (MKRMDataReportModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRMDataReportModel alloc] init];
    }
    return _dataModel;
}
