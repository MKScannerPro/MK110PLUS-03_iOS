//
//  MKRMMqttServerConfigFooterView.h
...
@interface MKRMMqttServerConfigFooterViewModel : NSObject
...
@protocol MKRMMqttServerConfigFooterViewDelegate <NSObject>
...
@interface MKRMMqttServerConfigFooterView : UIView

@property (nonatomic, strong)MKRMMqttServerConfigFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKRMMqttServerConfigFooterViewDelegate>delegate;
