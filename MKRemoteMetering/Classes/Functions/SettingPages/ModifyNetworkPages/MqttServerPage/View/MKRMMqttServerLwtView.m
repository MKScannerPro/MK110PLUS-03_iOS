...
@implementation MKRMMqttServerLwtViewModel
@end

@interface MKRMMqttServerLwtView ()
...
@implementation MKRMMqttServerLwtView
...
- (void)lwtButtonPressed {
    ...
    UIImage *lwtIcon = (self.lwtButton.selected ? LOADICON(@"MKRemoteMetering", @"MKRMMqttServerLwtView", @"rm_switchSelectedIcon.png") : LOADICON(@"MKRemoteMetering", @"MKRMMqttServerLwtView", @"rm_switchUnselectedIcon.png"));
...
- (void)retainButtonPressed {
    ...
    UIImage *retainIcon = (self.retainButton.selected ? LOADICON(@"MKRemoteMetering", @"MKRMMqttServerLwtView", @"rm_switchSelectedIcon.png") : LOADICON(@"MKRemoteMetering", @"MKRMMqttServerLwtView", @"rm_switchUnselectedIcon.png"));
...
#pragma mark - setter
- (void)setDataModel:(MKRMMqttServerLwtViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKRMMqttServerLwtViewModel.class]) {
        return;
    }
...
- (UIButton *)lwtButton {
    if (!_lwtButton) {
        ...
        [_lwtButton setImage:LOADICON(@"MKRemoteMetering", @"MKRMMqttServerLwtView", @"rm_switchUnselectedIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)retainButton {
    if (!_retainButton) {
        ...
        [_retainButton setImage:LOADICON(@"MKRemoteMetering", @"MKRMMqttServerLwtView", @"rm_switchUnselectedIcon.png") forState:UIControlStateNormal];
