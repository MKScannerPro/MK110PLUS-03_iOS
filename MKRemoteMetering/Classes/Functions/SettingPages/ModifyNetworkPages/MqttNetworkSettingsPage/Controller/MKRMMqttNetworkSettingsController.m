//
//  MKRMMqttNetworkSettingsController.m
...
@interface MKRMMqttNetworkSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKRMMqttNetworkSettingsModel *dataModel;

@end

@implementation MKRMMqttNetworkSettingsController

- (void)dealloc {
    NSLog(@"MKRMMqttNetworkSettingsController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteMetering", @"MKRMMqttNetworkSettingsController", @"rm_saveIcon.png") forState:UIControlStateNormal];
...
- (MKRMMqttNetworkSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRMMqttNetworkSettingsModel alloc] init];
    }
    return _dataModel;
}
