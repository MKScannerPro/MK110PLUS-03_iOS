...
@interface MKRMDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKRMDeviceInfoModel *dataModel;

@end

@implementation MKRMDeviceInfoController

- (void)dealloc {
    NSLog(@"MKRMDeviceInfoController销毁");
}
...
- (MKRMDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRMDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
