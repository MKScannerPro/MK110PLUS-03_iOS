...
@implementation MKRMDeviceInfoModel
...
- (BOOL)readDeviceInfo {
    ...
    [MKRMMQTTInterface rm_readDeviceInfoWithMacAddress:[MKRMDeviceModeManager shared].macAddress topic:[MKRMDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        ...
        self.wifiStaMac = [MKRMDeviceModeManager shared].macAddress;
