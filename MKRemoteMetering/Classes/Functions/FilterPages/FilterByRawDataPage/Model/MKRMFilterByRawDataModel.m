...
@interface MKRMFilterByRawDataModel ()
...
@implementation MKRMFilterByRawDataModel
...
- (BOOL)readFilterByRawData {
    ...
    [MKRMMQTTInterface rm_readFilterByRawDataStatusWithMacAddress:[MKRMDeviceModeManager shared].macAddress topic:[MKRMDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
