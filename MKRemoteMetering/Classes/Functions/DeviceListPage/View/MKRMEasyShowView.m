...
@implementation MKRMEasyShowView
...
- (UIImageView *)refreshIcon {
    if (!_refreshIcon) {
        ...
        _refreshIcon.image = LOADICON(@"MKRemoteMetering", @"MKRMEasyShowView", @"rm_refreshIcon.png");
    }
    return _refreshIcon;
}
