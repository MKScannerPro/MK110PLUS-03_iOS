...
extern NSString *const mk_rm_peripheralConnectStateChangedNotification;

//Notification of changes in the status of the Bluetooth Center.
extern NSString *const mk_rm_centralManagerStateChangedNotification;
 ...
 */
extern NSString *const mk_rm_deviceDisconnectTypeNotification;

@class CBCentralManager,CBPeripheral;
@class MKRMOperation;

@interface MKRMCentralManager : NSObject<MKBLEBaseCentralManagerProtocol>

@property (nonatomic, weak)id <mk_rm_centralManagerScanDelegate>delegate;

/// Current connection status
@property (nonatomic, assign, readonly)mk_rm_centralConnectStatus connectStatus;
