...
@implementation MKRMInterface (MKRMConfig)
...
+ (void)rm_enterSTAModeWithSucBlock:(void (^)(void))sucBlock
    ...
    [self configDataWithTaskID:mk_rm_taskEnterSTAModeOperation
                          data:commandString
                      sucBlock:sucBlock
...
+ (void)rm_configNTPServerHost:(NSString *)host
    ...
    NSString *tempString = [MKRMSDKDataAdopter fetchAsciiCode:host];
    ...
    [self configDataWithTaskID:mk_rm_taskConfigNTPServerHostOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configTimeZone:(NSInteger)timeZone
    ...
    [self configDataWithTaskID:mk_rm_taskConfigTimeZoneOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configDeviceTime:(unsigned long)timestamp
    ...
    [self configDataWithTaskID:mk_rm_taskConfigDeviceTimeOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configServerHost:(NSString *)host
    ...
    [self configDataWithTaskID:mk_rm_taskConfigServerHostOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configServerPort:(NSInteger)port
    ...
    [self configDataWithTaskID:mk_rm_taskConfigServerPortOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configClientID:(NSString *)clientID
    ...
    NSString *tempString = [MKRMSDKDataAdopter fetchAsciiCode:clientID];
    ...
    [self configDataWithTaskID:mk_rm_taskConfigClientIDOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configServerUserName:(NSString *)userName
    ...
    if (!MKValidStr(userName)) {
        ...
        [self configDataWithTaskID:mk_rm_taskConfigServerUserNameOperation
                              data:commandString
                          sucBlock:sucBlock
                       failedBlock:failedBlock];
        return;
    ...
    dispatch_async(queue, ^{
        for (NSInteger i = 0; i < totalNum; i ++) {
            ...
            NSString *asciiChar = [MKRMSDKDataAdopter fetchAsciiCode:[userName substringWithRange:NSMakeRange(i * packDataMaxLen, len)]];
            ...
            BOOL success = [self sendDataToPeripheral:commandString
                                               taskID:mk_rm_taskConfigServerUserNameOperation
                                            semaphore:semaphore];
            if (!success) {
...
+ (void)rm_configServerPassword:(NSString *)password
    ...
    if (!MKValidStr(password)) {
        ...
        [self configDataWithTaskID:mk_rm_taskConfigServerPasswordOperation
                              data:commandString
                          sucBlock:sucBlock
                       failedBlock:failedBlock];
        return;
    ...
    dispatch_async(queue, ^{
        for (NSInteger i = 0; i < totalNum; i ++) {
            ...
            NSString *lenString = [MKBLEBaseSDKAdopter fetchHexValue:len byteLen:1];
            NSString *asciiChar = [MKRMSDKDataAdopter fetchAsciiCode:[password substringWithRange:NSMakeRange(i * packDataMaxLen, len)]];
            NSString *commandString = [NSString stringWithFormat:@"%@%@%@%@%@",commandHeader,totalNumString,index,lenString,asciiChar];
            BOOL success = [self sendDataToPeripheral:commandString
                                               taskID:mk_rm_taskConfigServerPasswordOperation
                                            semaphore:semaphore];
            if (!success) {
                [MKBLEBaseSDKAdopter operationSetParamsErrorBlock:failedBlock];
                return;
...
+ (void)rm_configServerCleanSession:(BOOL)clean
    ...
    [self configDataWithTaskID:mk_rm_taskConfigServerCleanSessionOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configServerKeepAlive:(NSInteger)interval
    ...
    [self configDataWithTaskID:mk_rm_taskConfigServerKeepAliveOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configServerQos:(mk_rm_mqttServerQosMode)mode
                  sucBlock:(void (^)(void))sucBlock
               failedBlock:(void (^)(NSError *error))failedBlock {
    NSString *qosString = [MKRMSDKDataAdopter fetchMqttServerQosMode:mode];
    NSString *commandString = [@"ed012701" stringByAppendingString:qosString];
    [self configDataWithTaskID:mk_rm_taskConfigServerQosOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configSubscibeTopic:(NSString *)subscibeTopic
    ...
    NSString *tempString = [MKRMSDKDataAdopter fetchAsciiCode:subscibeTopic];
    ...
    [self configDataWithTaskID:mk_rm_taskConfigSubscibeTopicOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configPublishTopic:(NSString *)publishTopic
    ...
    NSString *tempString = [MKRMSDKDataAdopter fetchAsciiCode:publishTopic];
    ...
    [self configDataWithTaskID:mk_rm_taskConfigPublishTopicOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configLWTStatus:(BOOL)isOn
    ...
    [self configDataWithTaskID:mk_rm_taskConfigLWTStatusOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configLWTQos:(mk_rm_mqttServerQosMode)mode
    ...
    [self configDataWithTaskID:mk_rm_taskConfigLWTQosOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configLWTRetain:(BOOL)isOn
    ...
    [self configDataWithTaskID:mk_rm_taskConfigLWTRetainOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configLWTTopic:(NSString *)topic
    ...
    NSString *tempString = [MKRMSDKDataAdopter fetchAsciiCode:topic];
    ...
    [self configDataWithTaskID:mk_rm_taskConfigLWTTopicOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configLWTPayload:(NSString *)payload
    ...
    NSString *tempString = [MKRMSDKDataAdopter fetchAsciiCode:payload];
    ...
    [self configDataWithTaskID:mk_rm_taskConfigLWTPayloadOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configConnectMode:(mk_rm_connectMode)mode
                    sucBlock:(void (^)(void))sucBlock
                 failedBlock:(void (^)(NSError *error))failedBlock {
    NSString *modeString = [MKRMSDKDataAdopter fetchConnectModeString:mode];
    NSString *commandString = [@"ed012f01" stringByAppendingString:modeString];
    [self configDataWithTaskID:mk_rm_taskConfigConnectModeOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configCAFile:(NSData *)caFile
    ...
    dispatch_async(queue, ^{
        for (NSInteger i = 0; i < totalNum; i ++) {
            ...
            BOOL success = [self sendDataToPeripheral:commandString
                                               taskID:mk_rm_taskConfigCAFileOperation
                                            semaphore:semaphore];
            if (!success) {
                [MKBLEBaseSDKAdopter operationSetParamsErrorBlock:failedBlock];
                return;
...
+ (void)rm_configClientCert:(NSData *)cert
    ...
    dispatch_async(queue, ^{
        for (NSInteger i = 0; i < totalNum; i ++) {
            ...
            NSString *commandString = [NSString stringWithFormat:@"%@%@%@%@",commandHeader,index,lenString,subChar];
            BOOL success = [self sendDataToPeripheral:commandString
                                               taskID:mk_rm_taskConfigClientCertOperation
                                            semaphore:semaphore];
            if (!success) {
                [MKBLEBaseSDKAdopter operationSetParamsErrorBlock:failedBlock];
                return;
...
+ (void)rm_configClientPrivateKey:(NSData *)privateKey
    ...
    dispatch_async(queue, ^{
        for (NSInteger i = 0; i < totalNum; i ++) {
            ...
            NSString *commandString = [NSString stringWithFormat:@"%@%@%@%@",commandHeader,index,lenString,subChar];
            BOOL success = [self sendDataToPeripheral:commandString
                                               taskID:mk_rm_taskConfigClientPrivateKeyOperation
                                            semaphore:semaphore];
            if (!success) {
                [MKBLEBaseSDKAdopter operationSetParamsErrorBlock:failedBlock];
                return;
...
+ (void)rm_configWIFISecurity:(mk_rm_wifiSecurity)security
                     sucBlock:(void (^)(void))sucBlock
                  failedBlock:(void (^)(NSError *error))failedBlock {
    NSString *type = [MKRMSDKDataAdopter fetchWifiSecurity:security];
    NSString *commandString = [@"ed014001" stringByAppendingString:type];
    [self configDataWithTaskID:mk_rm_taskConfigWIFISecurityOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configWIFISSID:(NSString *)ssid
    ...
    NSString *tempString = [MKRMSDKDataAdopter fetchAsciiCode:ssid];
    ...
    [self configDataWithTaskID:mk_rm_taskConfigWIFISSIDOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configWIFIPassword:(NSString *)password
    ...
    NSString *tempString = [MKRMSDKDataAdopter fetchAsciiCode:password];
    ...
    [self configDataWithTaskID:mk_rm_taskConfigWIFIPasswordOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configWIFIEAPType:(mk_rm_eapType)eapType
                    sucBlock:(void (^)(void))sucBlock
                 failedBlock:(void (^)(NSError *error))failedBlock {
    NSString *type = [MKRMSDKDataAdopter fetchWifiEapType:eapType];
    NSString *commandString = [@"ed014301" stringByAppendingString:type];
    [self configDataWithTaskID:mk_rm_taskConfigWIFIEAPTypeOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configWIFIEAPUsername:(NSString *)username
    ...
    NSString *tempString = [MKRMSDKDataAdopter fetchAsciiCode:username];
    ...
    [self configDataWithTaskID:mk_rm_taskConfigWIFIEAPUsernameOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configWIFIEAPPassword:(NSString *)password
    ...
    [self configDataWithTaskID:mk_rm_taskConfigWIFIEAPPasswordOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configWIFIEAPDomainID:(NSString *)domainID
    ...
    NSString *tempString = [MKRMSDKDataAdopter fetchAsciiCode:domainID];
    ...
    [self configDataWithTaskID:mk_rm_taskConfigWIFIEAPDomainIDOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configWIFIVerifyServerStatus:(BOOL)verify
    ...
    [self configDataWithTaskID:mk_rm_taskConfigWIFIVerifyServerStatusOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configWIFICAFile:(NSData *)caFile
    ...
    dispatch_async(queue, ^{
        for (NSInteger i = 0; i < totalNum; i ++) {
            ...
            NSString *commandString = [NSString stringWithFormat:@"%@%@%@%@",commandHeader,index,lenString,subChar];
            BOOL success = [self sendDataToPeripheral:commandString
                                               taskID:mk_rm_taskConfigWIFICAFileOperation
                                            semaphore:semaphore];
            if (!success) {
                [MKBLEBaseSDKAdopter operationSetParamsErrorBlock:failedBlock];
                return;
...
+ (void)rm_configWIFIClientCert:(NSData *)cert
    ...
    dispatch_async(queue, ^{
        for (NSInteger i = 0; i < totalNum; i ++) {
            ...
            NSString *commandString = [NSString stringWithFormat:@"%@%@%@%@",commandHeader,index,lenString,subChar];
            BOOL success = [self sendDataToPeripheral:commandString
                                               taskID:mk_rm_taskConfigWIFIClientCertOperation
                                            semaphore:semaphore];
            if (!success) {
                [MKBLEBaseSDKAdopter operationSetParamsErrorBlock:failedBlock];
                return;
...
+ (void)rm_configWIFIClientPrivateKey:(NSData *)privateKey
    ...
    dispatch_async(queue, ^{
        for (NSInteger i = 0; i < totalNum; i ++) {
            ...
            NSString *commandString = [NSString stringWithFormat:@"%@%@%@%@",commandHeader,index,lenString,subChar];
            BOOL success = [self sendDataToPeripheral:commandString
                                               taskID:mk_rm_taskConfigWIFIClientPrivateKeyOperation
                                            semaphore:semaphore];
            if (!success) {
                [MKBLEBaseSDKAdopter operationSetParamsErrorBlock:failedBlock];
                return;
...
+ (void)rm_configDHCPStatus:(BOOL)isOn
    ...
    [self configDataWithTaskID:mk_rm_taskConfigDHCPStatusOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configIpAddress:(NSString *)ip
                  ...
                  sucBlock:(void (^)(void))sucBlock
               failedBlock:(void (^)(NSError *error))failedBlock {
    if (![MKRMSDKDataAdopter isIpAddress:ip] || ![MKRMSDKDataAdopter isIpAddress:mask]
        || ![MKRMSDKDataAdopter isIpAddress:gateway] || ![MKRMSDKDataAdopter isIpAddress:dns]) {
        [MKBLEBaseSDKAdopter operationParamsErrorBlock:failedBlock];
        return;
    }
    NSString *ipValue = [MKRMSDKDataAdopter ipAddressToHex:ip];
    NSString *maskValue = [MKRMSDKDataAdopter ipAddressToHex:mask];
    NSString *gatewayValue = [MKRMSDKDataAdopter ipAddressToHex:gateway];
    NSString *dnsValue = [MKRMSDKDataAdopter ipAddressToHex:dns];
    NSString *commandString = [NSString stringWithFormat:@"%@%@%@%@%@",@"ed014c10",ipValue,maskValue,gatewayValue,dnsValue];
    [self configDataWithTaskID:mk_rm_taskConfigIpInfoOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configCountryBand:(NSInteger)parameter
    ...
    [self configDataWithTaskID:mk_rm_taskConfigCountryBandOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configRssiFilterValue:(NSInteger)rssi
    ...
    [self configDataWithTaskID:mk_rm_taskConfigRssiFilterValueOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configFilterRelationship:(mk_rm_filterRelationship)relationship
    ...
    [self configDataWithTaskID:mk_rm_taskConfigFilterRelationshipOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configFilterMACAddressList:(NSArray <NSString *>*)macList
    ...
    [self configDataWithTaskID:mk_rm_taskConfigFilterMACAddressListOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configFilterAdvNameList:(NSArray <NSString *>*)nameList
    ...
    if (!MKValidArray(nameList)) {
        ...
        [self configDataWithTaskID:mk_rm_taskConfigFilterAdvNameListOperation
                              data:commandString
                          sucBlock:sucBlock
                       failedBlock:failedBlock];
        return;
    ...
    dispatch_source_set_event_handler(timer, ^{
        if (commandIndex >= commandList.count) {
            ...
            MKRMOperation *operation = [[MKRMOperation alloc] initOperationWithID:mk_rm_taskConfigFilterAdvNameListOperation commandBlock:^{
            ...
            [[MKRMCentralManager shared] addOperation:operation];
            return;
        }
        ...
        [[MKBLEBaseCentralManager shared] sendDataToPeripheral:commandString characteristic:peripheral.rm_custom type:CBCharacteristicWriteWithResponse];
        commandIndex ++;
    });
...
+ (void)rm_configAdvertiseBeaconStatus:(BOOL)isOn
    ...
    [self configDataWithTaskID:mk_rm_taskConfigAdvertiseBeaconStatusOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configBeaconMajor:(NSInteger)major
    ...
    [self configDataWithTaskID:mk_rm_taskConfigBeaconMajorOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configBeaconMinor:(NSInteger)minor
    ...
    [self configDataWithTaskID:mk_rm_taskConfigBeaconMinorOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configBeaconUUID:(NSString *)uuid
    ...
    [self configDataWithTaskID:mk_rm_taskConfigBeaconUUIDOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configAdvInterval:(NSInteger)interval
    ...
    [self configDataWithTaskID:mk_rm_taskConfigAdvIntervalOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configTxPower:(NSInteger)txPower
    ...
    [self configDataWithTaskID:mk_rm_taskConfigTxPowerOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configMeteringSwitch:(BOOL)isOn
    ...
    [self configDataWithTaskID:mk_rm_taskConfigMeteringSwitchOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configPowerReportInterval:(NSInteger)interval
    ...
    [self configDataWithTaskID:mk_rm_taskConfigPowerReportIntervalOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configEnergyReportInterval:(NSInteger)interval
    ...
    [self configDataWithTaskID:mk_rm_taskConfigEnergyReportIntervalOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)rm_configLoadDetectionNotificationStatus:(BOOL)isOn
    ...
    [self configDataWithTaskID:mk_rm_taskConfigLoadDetectionNotificationStatusOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)configDataWithTaskID:(mk_rm_taskOperationID)taskID
                        data:(NSString *)data
                    sucBlock:(void (^)(void))sucBlock
                 failedBlock:(void (^)(NSError *error))failedBlock {
    [centralManager addTaskWithTaskID:taskID characteristic:peripheral.rm_custom commandData:data successBlock:^(id  _Nonnull returnData) {
...
+ (BOOL)sendDataToPeripheral:(NSString *)commandString
                      taskID:(mk_rm_taskOperationID)taskID
