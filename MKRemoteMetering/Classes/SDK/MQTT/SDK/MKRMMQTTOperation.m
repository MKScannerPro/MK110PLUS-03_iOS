...
/**
 线程ID
 */
@property (nonatomic, assign)mk_rm_serverOperationID operationID;
...
@implementation MKRMMQTTOperation
@synthesize executing = _executing;
@synthesize finished = _finished;

- (void)dealloc{
    NSLog(@"MKRMMQTTOperation销毁");
}
...
#pragma mark - MKRMMQTTOperationProtocol
...
- (void)didReceiveMessage:(NSDictionary *)data onTopic:(NSString *)topic {
    ...
    [self dataParserReceivedData:[MKRMMQTTTaskAdopter parseDataWithJson:data topic:topic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_rm_serverOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_rm_defaultServerOperationID || operationID != self.operationID) {
        return;
    }
