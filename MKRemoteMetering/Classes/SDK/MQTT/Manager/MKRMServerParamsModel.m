...
static NSString *const fileName = @"MKRMServerParams.txt";

@interface MKRMServerParamsModel ()
...
@implementation MKRMServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKRMServerParamsProtocol>)protocol {
