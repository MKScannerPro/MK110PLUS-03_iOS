...
typedef NS_ENUM(NSInteger, MKRMDeviceModelState) {
    MKRMDeviceModelStateOffline,
    MKRMDeviceModelStateOnline,
};

//当设备离线的时候发出通知
extern NSString *const MKRMDeviceModelOfflineNotification;

@protocol MKRMDeviceModelDelegate <NSObject>
...
@interface MKRMDeviceModel : NSObject<MKRMDeviceModeManagerDataProtocol>
...
/**
 设备的状态，离线、在线
 */
@property (nonatomic, assign)MKRMDeviceModelState onLineState;

#pragma mark - 业务流程相关

@property (nonatomic, weak)id <MKRMDeviceModelDelegate>delegate;
