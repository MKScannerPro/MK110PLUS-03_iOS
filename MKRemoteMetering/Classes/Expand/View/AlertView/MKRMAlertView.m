...
@implementation MKRMAlertViewModel
@end

@interface MKRMAlertView ()
...
@implementation MKRMAlertView

- (void)dealloc {
    NSLog(@"MKRMAlertView销毁");
}
...
- (void)showWithModel:(MKRMAlertViewModel *)dataModel
    ...
    if (!dataModel || ![dataModel isKindOfClass:MKRMAlertViewModel.class]) {
        return;
    }
