...
@interface MKRMImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKRMImportServerController

- (void)dealloc {
    NSLog(@"MKRMImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(rm_selectedServerParams:)]) {
        [self.delegate rm_selectedServerParams:model.leftMsg];
    }
