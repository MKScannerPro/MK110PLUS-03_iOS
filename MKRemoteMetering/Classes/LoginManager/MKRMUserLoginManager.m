...
static MKRMUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKRMUserLoginManager ()
...
+ (MKRMUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKRMUserLoginManager new];
        }
    });
    return loginManager;
}
